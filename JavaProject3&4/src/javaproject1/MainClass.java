...
//               String community_name = input.next();
                ...
                for (Community community : c.getCommunityhistory()) {
                    ...
                    System.out.println("No of people in Abnormal Blood pressure in " + community.getCommunity() + " are " + communityno);
                    communityno = 0;
                }
                System.out.println("No of people in Abnormal Blood pressure in Boston city are " + totalpersonabnormal);
            }
